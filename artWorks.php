...
<html>
    ...
    <body>
        ...
        <p><?=$listArtWork->lastName?></p>
        <p><?=$listArtWork->firstName?></p>
        <p><?=$listArtWork->name?></p>
        <form method="POST" action="#"><button name="artWorkId" value="<?=$listArtWork->id?>">Ajouter des Photos</button></form>
        <?php } ?>
